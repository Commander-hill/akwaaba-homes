...
exports.createPropertyValidation = [
    ...
    (0, express_validator_1.body)('pricePeriod').optional().isString().trim().escape(),
    (0, express_validator_1.body)('gateLockTime').optional().isString().trim().escape(),
    (0, express_validator_1.body)('visitorPolicy').optional().isString().trim().escape(),
    (0, express_validator_1.body)('quietHours').optional().isString().trim().escape(),
    (0, express_validator_1.body)('paymentSchedule').optional().isString().trim().escape(),
    (0, express_validator_1.body)('cautionDeposit').optional().isFloat({ min: 0 }).withMessage('Caution deposit must be a valid non-negative number'),
    (0, express_validator_1.body)('includedUtilities').optional().isArray().withMessage('Included utilities must be an array'),
...
exports.updatePropertyValidation = [
    ...
    (0, express_validator_1.body)('quietHours').optional().isString().trim().escape(),
    (0, express_validator_1.body)('paymentSchedule').optional().isString().trim().escape(),
    (0, express_validator_1.body)('cautionDeposit').optional().isFloat({ min: 0 }),
    (0, express_validator_1.body)('includedUtilities').optional().isArray().withMessage('Included utilities must be an array'),
