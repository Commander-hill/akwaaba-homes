...
router.get('/landlord/stats', auth_middleware_1.authenticate, (0, auth_middleware_1.authorizeRole)(['LANDLORD', 'ADMIN']), property_controller_1.getLandlordStats);
router.get('/landlord/mine', auth_middleware_1.authenticate, (0, auth_middleware_1.authorizeRole)(['LANDLORD', 'ADMIN']), property_controller_1.getLandlordProperties);
