...
router.get('/landlord/financial-ledger', auth_middleware_1.authenticate, (0, auth_middleware_1.authorizeRole)(['LANDLORD']), transaction_controller_1.getLandlordFinancialLedger);
router.get('/landlord/tax-report', auth_middleware_1.authenticate, (0, auth_middleware_1.authorizeRole)(['LANDLORD']), transaction_controller_1.exportGRATaxReport);
