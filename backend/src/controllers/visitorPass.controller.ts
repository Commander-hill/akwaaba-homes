 ...
 */
export const checkOutVisitorPass = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
 ...
 */
export const getPropertyVisitorPasses = async (req: Request, res: Response): Promise<void> => {
  try {
