...
exports.createPropertyValidation = [
    ...
    (0, express_validator_1.body)('roomType').notEmpty().withMessage('Room type is required').trim().escape(),
    (0, express_validator_1.body)('roomCapacity').isInt({ min: 1 }).withMessage('Room capacity must be at least 1'),
...
exports.updatePropertyValidation = [
    ...
    (0, express_validator_1.body)('roomType').optional().notEmpty().withMessage('Room type is required').trim().escape(),
    (0, express_validator_1.body)('roomCapacity').optional().isInt({ min: 1 }).withMessage('Room capacity must be at least 1'),
