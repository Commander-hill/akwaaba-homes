...
export default function EditPropertyPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    if (property) {
      let parsedUtils: string[] = [];
      try {
        parsedUtils = Array.isArray(property.includedUtilities) 
          ? property.includedUtilities 
          : property.includedUtilities ? JSON.parse(property.includedUtilities) : [];
      } catch (e) {
        parsedUtils = [];
      }
      ...
      setFormData({
        ...
        gateLockTime: property.gateLockTime || 'No Curfew / 24/7 Access',
        visitorPolicy: property.visitorPolicy || 'Day visitors allowed until 8 PM',
        quietHours: property.quietHours || 'From 10:00 PM',
        paymentSchedule: property.paymentSchedule || 'Full Academic Year',
        cautionDeposit: property.cautionDeposit ? property.cautionDeposit.toString() : '',
        includedUtilities: parsedUtils,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-transparent border border-[var(--border)] rounded-xl py-3 px-4 text-[var(--foreground)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-all"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent border border-[var(--border)] rounded-xl py-3 pl-10 pr-4 text-[var(--foreground)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-all"
                    />
                  </div>
                </div>
              </div>
