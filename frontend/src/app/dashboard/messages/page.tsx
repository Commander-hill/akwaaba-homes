      ...
      <div className="flex-1 flex flex-col bg-white dark:bg-[#12151D]">
        {activeConversation ? (
          <>
            ...
            {/* Quick Prompt Chips */}
            <div className="px-4 py-2 bg-zinc-50/70 dark:bg-zinc-900/50 border-t border-zinc-100 dark:border-zinc-800 flex items-center gap-1.5 overflow-x-auto scrollbar-none">
              ...
              {[
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg text-[11px] font-medium bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 hover:border-[#0F5132] hover:text-[#0F5132] dark:hover:text-emerald-400 whitespace-nowrap transition-colors cursor-pointer shrink-0"
                >
                  {chip}
                </button>
              ))}
            ...
            <div className="p-4 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#12151D] shrink-0">
              <form onSubmit={handleSendMessage} className="flex gap-2 items-center">
                <input
                  ...
                  placeholder="Type your message or select a prompt above..."
