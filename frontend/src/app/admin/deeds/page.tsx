        ...
        <div className="p-6 md:p-8 rounded-3xl bg-slate-900 text-white shadow-md relative overflow-hidden border border-slate-800 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="relative z-10 space-y-2 max-w-3xl">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white flex items-center gap-3">
              ...
              Land Title &amp; Property Deed Verification
            </h1>
          ...
          <div className="relative z-10 shrink-0 bg-slate-800 border border-slate-700 p-4 rounded-2xl text-center">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-300 block">Verification Standard</span>
            <span className="text-sm font-black text-white">Title Validation</span>
            <div className="text-[10px] text-emerald-400 font-semibold mt-0.5">Section 18 Deed Registry Act</div>
          </div>
        </div>
