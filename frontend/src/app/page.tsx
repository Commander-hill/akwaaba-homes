...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0A0A0E] text-slate-100 selection:bg-[#5B4CFF] selection:text-white">
      
      {/* ════════════════════════════════════════════════════════════════
          1. HERO HEADER SECTION (CONTAINED — NO FULL-PAGE WALLPAPER)
         ════════════════════════════════════════════════════════════════ */}
      <section className="relative min-h-[580px] lg:min-h-[660px] flex items-center justify-center pt-24 pb-20 overflow-hidden">
        
        {/* Strictly contained hero background with multi-tier dark gradient fade */}
        <div 
        ...
        {/* Bottom smooth fade directly into solid background */}
        <div className="absolute inset-0 z-0 bg-gradient-to-b from-black/40 via-[#0A0A0E]/80 to-[#0A0A0E]" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          {/* Top Trust Pill */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/15 mb-6 text-xs font-semibold text-slate-200 shadow-xl">
            <span className="flex h-2 w-2 rounded-full bg-emerald-400 animate-pulse"></span>
            Ghana's Premier Housing Platform for Students, Families &amp; Professionals
          </div>
          
          {/* Main Headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight mb-4 text-white leading-[1.15]">
          ...
          {/* Subtitle */}
          <p className="text-xs sm:text-sm md:text-base text-slate-300 max-w-2xl mx-auto mb-8 leading-relaxed font-medium">
          ...
          {/* ── SEARCH COMMAND CAPSULE ── */}
          <div className="max-w-4xl mx-auto bg-[#12131A]/95 backdrop-blur-2xl rounded-3xl p-3 sm:p-4 shadow-2xl border border-white/15 text-left">
            
            {/* Segmented Category Tabs */}
            <div className="flex items-center gap-2 pb-3 mb-3 border-b border-white/10 overflow-x-auto scrollbar-none">
              {[
            ...
            <form onSubmit={handleSearchSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
              ...
              {/* Location Input */}
              <div className="flex items-center gap-2.5 px-3.5 py-3 bg-white/5 rounded-2xl border border-white/10 focus-within:border-[#5B4CFF] transition-all">
                ...
                <input 
                  ...
                  className="w-full bg-transparent border-none outline-none text-white placeholder:text-slate-400 text-xs font-medium"
                />
              </div>

              {/* Budget Range */}
              <div className="flex items-center gap-2.5 px-3.5 py-3 bg-white/5 rounded-2xl border border-white/10 focus-within:border-[#5B4CFF] transition-all">
                <DollarSign className="text-emerald-400 w-4 h-4 shrink-0" />
                <select
                  value={searchBudget}
                  onChange={(e) => setSearchBudget(e.target.value)}
                  aria-label="Filter by Budget Range"
                  className="w-full bg-transparent border-none outline-none text-white text-xs font-medium cursor-pointer [&>option]:bg-slate-900 [&>option]:text-white"
                >
              ...
              {/* Price Period */}
              <div className="flex items-center gap-2.5 px-3.5 py-3 bg-white/5 rounded-2xl border border-white/10 focus-within:border-[#5B4CFF] transition-all">
                <Clock className="text-indigo-400 w-4 h-4 shrink-0" />
                <select
                  value={searchPeriod}
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
            <span className="text-[11px] font-bold text-slate-400 flex items-center gap-1">
              <GraduationCap className="w-3.5 h-3.5 text-amber-400" /> Popular Campuses:
            </span>
            {POPULAR_CAMPUSES.map((c) => (
              <button
                ...
                className="px-3 py-1 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 hover:text-white text-[11px] font-semibold transition-all cursor-pointer"
              >
                📍 {c.name}
              </button>
            ))}
      ...
      {/* ════════════════════════════════════════════════════════════════
          2. SEAMLESS TRUST & SECURITY STRIP (INTEGRATED INTO PAGE)
         ════════════════════════════════════════════════════════════════ */}
      <section className="relative z-10 border-y border-white/10 bg-[#0E0F16]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-xs font-black text-white">100% Escrow Protection</div>
                <p className="text-[11px] text-slate-400">Funds locked safe until move-in</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-xs font-black text-white">Ghana Card Verified</div>
                <p className="text-[11px] text-slate-400">Strict KYC on hosts &amp; porters</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-xs font-black text-white">Instant MoMo &amp; Bank</div>
                <p className="text-[11px] text-slate-400">MTN, Telecel, AT, GHIPSS</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-xs font-black text-white">Zero Agent Fraud</div>
                <p className="text-[11px] text-slate-400">Direct landlord &amp; caretaker link</p>
              </div>
            </div>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link 
            href="/properties" 
            className="text-xs font-bold text-[#5B4CFF] hover:text-indigo-400 flex items-center gap-1"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3.5">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className="p-5 rounded-2xl bg-[#12131A] hover:bg-[#181A24] border border-white/5 hover:border-[#5B4CFF]/40 text-left transition-all group cursor-pointer shadow-sm hover:shadow-xl hover:-translate-y-1"
            >
              <div className="text-3xl mb-3">{cat.icon}</div>
              <h3 className="text-sm font-black text-white group-hover:text-[#5B4CFF] transition-colors">
                {cat.name}
              </h3>
              <p className="text-[11px] text-slate-400 mt-1 line-clamp-2 leading-relaxed">
                {cat.desc}
              </p>
              <div className="mt-3 text-[10px] font-bold text-amber-400">
                {cat.count}
              </div>
            </button>
          ))}
      ...
      {/* ════════════════════════════════════════════════════════════════
         ...
         ════════════════════════════════════════════════════════════════ */}
      <section className="py-16 bg-[#0E0F16] border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-1.5">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-500/10 text-indigo-400 rounded-full text-[11px] font-bold uppercase border border-indigo-500/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Step 1 */}
            <div className="p-6 rounded-3xl bg-[#14151E] border border-white/10 relative flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-2xl bg-indigo-600/20 border border-indigo-500/30 text-indigo-400 flex items-center justify-center font-black text-base">
                  01
                </div>
                <h3 className="text-base font-extrabold text-white">Browse &amp; Virtual Tour</h3>
              ...
              <div className="pt-4 mt-4 border-t border-white/5 text-[11px] font-bold text-indigo-400 flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" /> 100% Genuine Owner Listings
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#14151E] border border-white/10 relative flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-2xl bg-emerald-600/20 border border-emerald-500/30 text-emerald-400 flex items-center justify-center font-black text-base">
                  02
                </div>
                <h3 className="text-base font-extrabold text-white">Reserve &amp; Digital Lease</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-white/5 text-[11px] font-bold text-emerald-400 flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" /> Escrow-Secured &amp; Signed Contract
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#14151E] border border-white/10 relative flex flex-col justify-between">
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-2xl bg-amber-600/20 border border-amber-500/30 text-amber-400 flex items-center justify-center font-black text-base">
                  03
                </div>
                <h3 className="text-base font-extrabold text-white">Move In &amp; Inspect</h3>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="pt-4 mt-4 border-t border-white/5 text-[11px] font-bold text-amber-400 flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" /> Digital Checklist &amp; Key Handover
              </div>
            </div>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-amber-500/10 text-amber-300 rounded-full text-[11px] font-bold uppercase mb-2">
          ...
          <Link
            href="/properties"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-[#5B4CFF] hover:bg-[#4B3DEE] text-white text-xs font-black transition-all shadow-md shrink-0 cursor-pointer"
          >
        ...
        {isPropsLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((n) => (
              <div key={n} className="h-80 rounded-3xl bg-white/5 animate-pulse" />
            ))}
          </div>
        ) : featuredProperties.length === 0 ? (
          <div className="p-12 rounded-3xl bg-[#12131A] border border-white/10 text-center space-y-4">
            <Building className="w-12 h-12 text-slate-500 mx-auto" />
            <h3 className="text-base font-bold text-white">No Properties Currently Listed</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredProperties.map((property) => (
              <div 
                key={property.id}
                className="group rounded-3xl bg-[#12131A] border border-white/10 hover:border-[#5B4CFF]/50 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  {/* Property Image */}
                  ...
                  <div className="p-5 space-y-2.5">
                    <h3 className="font-extrabold text-sm text-white line-clamp-1 group-hover:text-[#5B4CFF] transition-colors">
                      {property.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-2 text-[10px] font-bold text-slate-300">
                ...
                <div className="p-5 pt-0">
                  <Link
                    ...
                    className="w-full py-2.5 rounded-xl bg-white/10 hover:bg-[#5B4CFF] text-white text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                  >
      ...
      {/* ════════════════════════════════════════════════════════════════
         ...
         ════════════════════════════════════════════════════════════════ */}
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full border-t border-white/5">
        <div className="grid md:grid-cols-2 gap-6">
          
          {/* Landlord Portal */}
          <div className="p-8 rounded-3xl bg-[#12131A] border border-indigo-500/20 space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-black text-white">For Landlords &amp; Property Owners</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <ul className="space-y-1.5 text-xs text-slate-300 font-medium pt-1">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" /> Automated Paystack / MoMo Payouts</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" /> Porter &amp; Staff Delegation Hub</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" /> Digital Lease Signatures &amp; Tenant CRM</li>
              </ul>
            </div>
            ...
            <div className="pt-3">
              <Link
                href="/dashboard/landlord/new"
                className="px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black transition-all inline-flex items-center gap-2"
              >
          ...
          {/* Caretaker Portal */}
          <div className="p-8 rounded-3xl bg-[#12131A] border border-amber-500/20 space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-xl font-black text-white">For Caretakers &amp; Hostel Porters</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <ul className="space-y-1.5 text-xs text-slate-300 font-medium pt-1">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-amber-400 shrink-0" /> Digital Move-In Condition Checklists</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-amber-400 shrink-0" /> Maintenance Ticket Scheduling &amp; Proof Photos</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-amber-400 shrink-0" /> Front Desk Parcel Vault &amp; Gate PINs</li>
              </ul>
            </div>
            ...
            <div className="pt-3">
              <Link
                ...
                className="px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-black transition-all inline-flex items-center gap-2"
              >
      ...
      {/* ════════════════════════════════════════════════════════════════
         ...
         ════════════════════════════════════════════════════════════════ */}
      <footer className="bg-[#07070A] text-slate-400 pt-16 pb-12 border-t border-white/10">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  ...
                  >
                    <Shield className="w-3 h-3" /> Admin Security Portal
                  </Link>
                </li>
              </ul>
            </div>
